...
*   \file DblLink.h
*   \brief Header file for DblLink, DblLinkItr, and node classes and their respective implementations
*/
...
{	private:
        ...
        /*!
        *   \fn Constructor
        *   \param info the data that will populate the node
        *   \param pLink pointer to the previous node
        *   \param rLink pointer to the next node
        *   \return none
        */
        ...
        /*!
            data that will populate the node
        */
		eltType data;

        /*!
            points to previous node if applicable
        */
		Node*	prev; // points to previous node if applicable

        /*!
            points to next node if applicable
        */
...
/*!
*	\class DblLink
*	\brief Handles the creation, replication, insertion, and removal of a doubly linked list
*/
...
public:
    ...
    */
    ...
    /*!
    *   \fn Deep copy
    *   \param DblLink& Reference to a doubly linked list
    *   \return none
    */
    ...
    */
    ...
    /*!
    *   \fn operator=
    *   \param DblLink& Reference to to a doubly linked list
    *   \return DblLink
    */
    ...
    /*!
    *   \fn insert
    *   \brief insert element of eltType into doubly linked list
    *   \param eltType the element of element type to be inserted in doubly linked list
    *   \return none
    */
    void insert(eltType);
    ...
    /*!
    *   \fn remove
    *   \brief remove element of eltType from doubly linked list
    *   \param eltType the ement of element type to be removed from doubly linked list (if found)
    *   \return none
    */
    void remove(eltType);
...
private:
    ...
    */
    ...
    /*!
        points to the last element of doubly linked list
    */
    Node<eltType>* tail;
    ...
    /*!
    *   \fn copy
        \brief the copy forward function
    *   \param Node point to a node to copy its data
    *   \return Node
    */
    ...
    /*!
    *   \fn copyT
        \brief the copy backward function
    *   \param Node point to a node to copy its data
    *   \return Node
    */
    ...
    /*!
    *   \fn destroy
    *   \brief release doubly linked list nodes
    *   \param Node node to begin destroy from
    *   \return none
    */
...
/*!
*	\class DblLinkItr
*	\brief The doubly linked list iterator used to interface with a doubly linked list
*/
template <typename eltType> class DblLinkItr {
public:
    ...
    /*!
    *   \fn Constructor
    *   \param list Reference to a doubly linked list
    *   \return none
    */
    ...
    /*!
    *   \fn start
    *   \brief set iterator to the start (head)
    *   \param none
    *   \return none
    */
    void start();
    ...
    /*!
    *   \fn end
    *   \brief set iterator to the end (tail)
    *   \param none
    *   \return none
    */
    void end();
    ...
    /*!
    *   \fn isEmpty
    *   \brief check to see if doubly linked list is empty
    *   \param none
    ...
    */
    ...
    /*!
    *   \fn isLastNode
    *   \brief check to see if current node is the last (tail) node of doubly linked list
    *   \param none
    *   \return bool true is last node, false if not last node
    */
    bool isLastNode();
    ...
    /*!
    *   \fn isFirstNode
    *   \brief check to see if current node is the first (head) node of doubly linked list
    *   \param none
    *   \return bool true is first node, false if not first node
    */
    bool isFirstNode();
    ...
    */
    ...
    /*!
    *   \fn operator--()
    *   \brief move to the previus node
    *   \param none
    *   \return DblLinkItr&
    */
    DblLinkItr& operator--() {
    ...
    /*!
    *   \fn operator( )()
    *   \brief return data of current node
    *   \param none
    *   \return eltType data of the node that is returned
    */
    eltType operator( )() {
        return current->data;
    }
